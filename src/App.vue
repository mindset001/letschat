  ...
  >
    ...
    <form class="login-form" @submit.prevent="Login">
      <div class="form-inner">
		...
		<!-- <img src="https://res.cloudinary.com/mindset/image/upload/v1629988202/undraw_enter_uhqk_khhg8c.png" alt="" style="height: 60%; width:80%; align-item: center;"> -->
      </div>
    </form>
  </div>
  ...
  <div class="view chat" v-else>
    ...
    <section class="chat-box">
      <div
        ...
        :key="message.key"
        :class="{
          'message current-user': message.username === state.username,
